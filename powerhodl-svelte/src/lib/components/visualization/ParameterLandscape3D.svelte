...
<script>
	...
	export let surfaceResolution = 'medium'; // 'low', 'medium', 'high'
	...
	<div class="viz-controls">
		<div class="control-group">
			...
			<div class="control-subtitle">
				Interactive optimization surface with {surfaceResolution} resolution
			</div>
		</div>
		...
		<div class="control-row">
			...
			<div class="control-item">
				...
				<select bind:value={surfaceResolution} class="control-select">
			...
			<!-- Surface Opacity -->
			<div class="control-item">
				<label class="control-label">Surface Opacity:</label>
				<input 
					type="range" 
					min="0.1" 
					max="1.0" 
					step="0.1"
					bind:value={visualSettings.surfaceOpacity}
					class="control-slider"
				/>
				<span class="control-value">{(visualSettings.surfaceOpacity * 100).toFixed(0)}%</span>
			</div>
			
			<!-- Color Scheme -->
			<div class="control-item">
				<label class="control-label">Color Scheme:</label>
				<select bind:value={visualSettings.colorScale} class="control-select">
					<option value="Viridis">Viridis</option>
					<option value="Plasma">Plasma</option>
					<option value="Hot">Hot</option>
					<option value="RdYlBu">Red-Blue</option>
		...
		<div class="control-row">
			<!-- Fixed Parameters -->
			<div class="control-item">
				<label class="control-label">Transaction Cost:</label>
				<input 
					type="number" 
					min="0.5" 
					max="3.0" 
					step="0.1"
					value={fixedParameters.transactionCost}
					on:input={(e) => handleParameterChange('transactionCost', parseFloat(e.target.value))}
					class="control-input"
				/>
			...
			<div class="control-item">
				<label class="control-label">Lookback Window:</label>
				<input 
					type="number" 
					min="5" 
					max="30" 
					step="1"
					value={fixedParameters.lookbackWindow}
					on:input={(e) => handleParameterChange('lookbackWindow', parseInt(e.target.value))}
					class="control-input"
				/>
			...
			<div class="control-item">
				<label class="control-label">Volatility Filter:</label>
				<input 
					type="number" 
					min="0.1" 
					max="1.0" 
					step="0.1"
					value={fixedParameters.volatilityFilter}
					on:input={(e) => handleParameterChange('volatilityFilter', parseFloat(e.target.value))}
					class="control-input"
				/>
			</div>
		</div>
		...
		<div class="control-row">
			...
			<div class="control-item">
				<label class="checkbox-control">
					<input 
						type="checkbox" 
						bind:checked={showOptimizationTrail}
					/>
			...
			<div class="control-item">
				<label class="checkbox-control">
					<input 
						type="checkbox" 
						bind:checked={visualSettings.showContours}
					/>
					<span class="checkbox-text">Show Contour Lines</span>
				</label>
			</div>
