...
export class MarketDataService {
    ...
    initializeExchange() {
        try {
            // Use Coinbase Pro instead of Binance to avoid geographical restrictions
            ...
            this.logger.info('Coinbase Pro exchange initialized');
        } catch (error) {
    ...
    /**
     * Get current market data from Coinbase Pro
     * @returns {Promise<Object>} Market data with prices and volumes
     */
    async getCurrentMarketData() {
        try {
            this.logger.debug('Fetching current market data from Coinbase Pro');
